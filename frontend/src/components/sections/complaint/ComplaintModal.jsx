...
const ComplaintModal = ({ open, setOpen, onSuccess }) => {
        ...
        <div className="premium-modal-overlay">
          ...
          >
            ...
            <div className="modal-footer">
              <button className="cancel-button" onClick={() => setOpen(false)} disabled={loading}>
                Cancel
              </button>
              <button className="submit-button" onClick={submitComplaint} disabled={loading}>
